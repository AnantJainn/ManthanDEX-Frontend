...
type Property1Frame480956162Type = {
  image10?: string;
  vector583?: string;
...
const Property1Frame480956162: FunctionComponent<Property1Frame480956162Type> =
  memo(
    ({
      image10,
      vector583,
      ...
      const property1Frame480956162Style: CSS.Properties = useMemo(() => {
        return {
      ...
      const frameDiv68Style: CSS.Properties = useMemo(() => {
        return {
...
export default Property1Frame480956162;
