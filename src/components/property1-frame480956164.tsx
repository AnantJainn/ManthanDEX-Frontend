...
type Property1Frame480956164Type = {
  image13?: string;
  vector583?: string;
...
const Property1Frame480956164: FunctionComponent<Property1Frame480956164Type> =
  memo(
    ({
      image13,
      vector583,
      ...
      const property1Frame480956164Style: CSS.Properties = useMemo(() => {
        return {
      ...
      const frameDiv70Style: CSS.Properties = useMemo(() => {
        return {
...
export default Property1Frame480956164;
