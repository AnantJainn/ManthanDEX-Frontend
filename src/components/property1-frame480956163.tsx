...
type Property1Frame480956163Type = {
...
const Property1Frame480956163: FunctionComponent<Property1Frame480956163Type> =
  memo(
    ({
      ...
      const property1Frame480956163Style: CSS.Properties = useMemo(() => {
        return {
      ...
      const frameDiv69Style: CSS.Properties = useMemo(() => {
        return {
...
export default Property1Frame480956163;
