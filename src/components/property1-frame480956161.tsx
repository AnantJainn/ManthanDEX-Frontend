...
type Property1Frame480956161Type = {
  image12?: string;
  vector583?: string;
...
const Property1Frame480956161: FunctionComponent<Property1Frame480956161Type> =
  memo(
    ({
      image12,
      vector583,
      ...
      const property1Frame480956161Style: CSS.Properties = useMemo(() => {
        return {
      ...
      const frameDiv67Style: CSS.Properties = useMemo(() => {
        return {
      ...
      return (
        <div
          ...
          style={property1Frame480956161Style}
        >
          <div
            className="h-[106px] flex flex-col items-start justify-between"
            style={frameDiv67Style}
          >
            <div className="w-[209px] flex flex-row items-center justify-start">
...
export default Property1Frame480956161;
