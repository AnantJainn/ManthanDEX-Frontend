...
const TestimonialContainer: FunctionComponent = memo(() => {
  return (
    <section className="absolute top-[268.5rem] left-[calc(50%_-_720px)] bg-gray-700 w-[90rem] overflow-hidden flex flex-col py-[3.75rem] px-[0rem] box-border items-start justify-start text-center text-[2.5rem] text-darkturquoise font-bai-jamjuree">
